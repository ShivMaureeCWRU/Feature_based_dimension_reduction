...
REPRESENTATIONS_DIR = "../SignAlphaSet_representations"
OUTPUT_BASE_DIR = "../SignAlphaSet_random_forest_outputs"
MODEL_BASE_DIR = "../models/SignAlphaSet_random_forest_models"
...
SUMMARY_LOG_PATH = os.path.join(
    OUTPUT_BASE_DIR,
    "SignAlphaSet_random_forest_console_summary.txt"
)

with open(SUMMARY_LOG_PATH, "w", encoding="utf-8") as f:
    f.write("Random Forest Results Across SignAlphaSet Representations\n")
...
for representation_name, file_name in representation_files.items():
    ...
    tuning_results_df.to_csv(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_tuning_results.csv"),
        index=False
    )
    ...
    best_params_df.to_csv(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_best_params.csv"),
        index=False
    )
    ...
    cm_df.to_csv(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_confusion_matrix.csv")
    )
    ...
    report_df.to_csv(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_classification_report.csv")
    )
    ...
    importance_df.to_csv(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_feature_importances.csv"),
        index=False
    )
    ...
    summary_df.to_csv(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_summary.csv"),
        index=False
    )
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_confusion_matrix_plot.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_accuracy_plot.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_classification_report_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_summary_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_best_params_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_top_feature_importances.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR, "SignAlphaSet_random_forest_all_feature_importances.png"),
        dpi=300
    )
    plt.close()
    ...
    dump(
        random_forest_model,
        os.path.join(MODEL_DIR, f"SignAlphaSet_random_forest_{representation_name}.joblib")
    )
...
all_results_df.to_csv(
    os.path.join(OUTPUT_BASE_DIR, "SignAlphaSet_random_forest_all_representations_summary.csv"),
    index=False
)
...
if len(all_results_df) > 0:
    ...
    plt.title("Random Forest Test Accuracy Across SignAlphaSet Representations")
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_BASE_DIR, "SignAlphaSet_random_forest_representation_test_accuracy.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.title("Random Forest Cross-Validation Accuracy Across SignAlphaSet Representations")
    plt.xticks(rotation=45, ha="right")
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_BASE_DIR, "SignAlphaSet_random_forest_representation_cv_accuracy.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.title("Random Forest Results Across SignAlphaSet Feature Representations", pad=20)
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_BASE_DIR, "SignAlphaSet_random_forest_all_representations_summary_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
...
print("\nFinished running Random Forest on all available SignAlphaSet representations.")
