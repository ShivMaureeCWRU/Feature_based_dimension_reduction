...
OUTPUT_BASE_DIR="../logistic_regression_outputs"
MODEL_BASE_DIR="../models/logistic_regression_models"
...
SUMMARY_LOG_PATH=os.path.join(
    OUTPUT_BASE_DIR,
    "logistic_regression_console_summary.txt"
)
...
for representation_name,file_name in representation_files.items():
    ...
    tuning_results_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_tuning_results.csv"),
        index=False
    )
    ...
    best_params_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_best_params.csv"),
        index=False
    )
    ...
    report_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_classification_report.csv")
    )
    ...
    coefficient_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_coefficients.csv")
    )
    ...
    top_coef_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_top_coefficients.csv"),
        index=False
    )
    ...
    top_by_class_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_top_coefficients_by_class.csv"),
        index=False
    )
    ...
    summary_df.to_csv(
        os.path.join(OUTPUT_DIR,"logistic_regression_summary.csv"),
        index=False
    )
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_confusion_matrix_plot.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_accuracy_plot.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_classification_report_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_summary_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_best_params_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_coefficient_heatmap.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_DIR,"logistic_regression_top_coefficients.png"),
        dpi=300
    )
    plt.close()
    ...
    dump(
        logistic_model,
        os.path.join(MODEL_DIR,f"logistic_regression_{representation_name}.joblib")
    )
...
all_results_df.to_csv(
    os.path.join(OUTPUT_BASE_DIR,"logistic_regression_all_representations_summary.csv"),
    index=False
)
...
if len(all_results_df)>0:
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_BASE_DIR,"logistic_regression_representation_test_accuracy.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_BASE_DIR,"logistic_regression_representation_cv_accuracy.png"),
        dpi=300
    )
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(
        os.path.join(OUTPUT_BASE_DIR,"logistic_regression_all_representations_summary_plot.png"),
        dpi=300,
        bbox_inches="tight"
    )
    plt.close()
