...
print(f"Datasets created successfully with {len(labels)} samples.")
...
print("\nSaved files:")
print("raw_xy.pickle")
print("raw_xyz.pickle")
print("translated_xy.pickle")
print("scaled_xy.pickle")
print("distances_xy.pickle")
print("normalized_distances_xy.pickle")
print("angles_xy.pickle")
print("hybrid.pickle")