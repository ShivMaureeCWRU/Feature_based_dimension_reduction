...
DATA_DIR = "../SignAlphaSet_data"

OUTPUT_DIR = "../SignAlphaSet_representations"
...
for dir_ in sorted(os.listdir(DATA_DIR)):
    ...
    image_files = [
        img_path for img_path in sorted(os.listdir(class_dir))
        if img_path.lower().endswith(valid_extensions)
    ]

    image_files = image_files[:MAX_IMAGES_PER_CLASS]

    print(f"Processing class '{dir_}': using {len(image_files)} images")
...
print("SignAlphaSet representation datasets created successfully.")
print(f"Maximum images attempted per class: {MAX_IMAGES_PER_CLASS}")
